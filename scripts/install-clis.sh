...
# Public distribution surface: the product repo is private, so CLI release
# assets live on the Action's public mirror repo alongside the Action itself.
REPO="kioba/beaver-logs-ingest"
